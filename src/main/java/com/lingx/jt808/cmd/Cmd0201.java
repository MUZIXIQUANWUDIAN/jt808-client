 ...
 *
 */
public class Cmd0201 extends AbstractJT808Command {

	
	public Cmd0201(String tid,int msgSn,double lat,double lng,float speed,int height,int fx,float meilage,float oil,int bj,int zt) {
		super(0x0201, tid,getBody(tid,msgSn,lat,lng,speed,height,fx,meilage,oil,bj,zt));
	}
	
	public static byte[] getBody(String tid,int msgSn,double lat,double lng,float speed,int height,int fx,float meilage,float oil,int bj,int zt) {
	...
	public Cmd0201(String tid,double lat,double lng,float speed,int height,int fx,float meilage,float oil,int bj,int zt,int fjId,byte bytes[]) {
