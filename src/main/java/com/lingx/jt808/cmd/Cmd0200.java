...
public class Cmd0200 extends AbstractJT808Command {
	...
	public Cmd0200(String tid,double lat,double lng,float speed,int height,int fx,float meilage,float oil,int bj,int zt) {
		super(0x0200, tid,getBody(tid,lat,lng,speed,height,fx,meilage,oil,bj,zt));
	}
	...
	public Cmd0200(String tid,double lat,double lng,float speed,int height,int fx,float meilage,float oil,int bj,int zt,int fjId,byte bytes[]) {
